...
<body>
	<table class="table table-dark">
	  ...
	  <c:forEach var = "oneSectionsAndClasses" items = "${sectionsAndClasses }" >
		  		<tr>
		  			...
		  			<td><form action = "${oneSectionsAndClasses.classId}/${oneSectionsAndClasses.section.sectionId}" 
		  			method = "post">
		  				<button class="btn btn-success" type = "submit">Add teacher to this section</button>
					</form></td>
		  		</tr>
		  </c:forEach>
	...
	<form action = "${currUrl }/newSection" method = "get">
