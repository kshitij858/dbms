...
<body>
	...
	<h3>Teacher of this class and section are - </h3>
	<table class="table table-dark">
	  ...
	  <c:forEach var = "teacher" items = "${teachers }" >
		  		<tr>
		  			<th scope = "row"> 1</th>
		  			<td>${teacher.user.userId}</td><td>${teacher.user.username}</td>
...
<!-- 		  			<td> -->
<%-- 		  				<form action = "${currentUrl}/${teacher.user.userId}/updateGenInfo" method = "get"> --%>
<!-- 		  					<button class="btn btn-success" type = "submit">update general information</button> -->
<!-- 		  				</form> -->
<!-- 		  			</td> -->
<!-- 		  			<td> -->
<%-- 		  				<form action = "${currentUrl}/${teacher.user.userId}/updateSpecInfo" method = "get"> --%>
...
<!-- 		  			</td> -->
					<td><div class="btn-group">
						  ...
						  <div class="dropdown-menu">
						    <a class="dropdown-item" href="${currentUrl}/${teacher.user.userId}/classesOfTeacher">See classes of teacher</a>
						    <a class="dropdown-item" href="${currentUrl}/${teacher.user.userId}/addToClass">Add teacher to a class</a>
						  </div>
						</div>
					</td>
					...
					<td><div class="btn-group">
						  ...
						  <div class="dropdown-menu">
						    <a class="dropdown-item" href="${currentUrl}/${teacher.user.userId}/viewResponsibility">View Responsibilities</a>
						    <a class="dropdown-item" href="${currentUrl}/${teacher.user.userId}/addResponsibility">Give new responsibility</a>
						  </div>
						</div>
					</td>
<!-- 		  			<td> -->
<%-- 		  				<form action = "${currentUrl}/${teacher.user.userId}/addToClass" method = "get"> --%>
<!-- 		  					<button class="btn btn-success" type = "submit">add teacher to a class</button> -->
<!-- 		  				</form> -->
<!-- 		  			</td><td> -->
<%-- 		  				<form action = "${currentUrl}/${teacher.user.userId}/classesOfTeacher" method = "get"> --%>
<!-- 		  					<button class="btn btn-success" type = "submit">see all classes of teacher</button> -->
<!-- 		  				</form> -->
<!-- 		  			</td> -->
		  			<td>
		  				<form action = "${currentUrl}/${teacher.user.userId}/positionOfResponsibility" method = "get">
		  					<button class="btn btn-success" type = "submit">Position Of Responsibility</button>
		  				</form>
		  			</td>
		  			<td><form action = "/teacher/${teacher.user.username }/viewFeedback" method = "get">
