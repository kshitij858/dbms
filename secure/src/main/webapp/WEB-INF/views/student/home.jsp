...
<body>
	...
	<form  action = "${username }/viewClasses">
		<button type = "submit" class = "btn btn-success" > See your classes</button>
	</form>
	...
	<form  action = "${username }/viewPositionOfResponsibility">
		<button type = "submit" class = "btn btn-success" >View Responsibilities</button>
	</form>
	<form  action = "${username }/viewAchievement">
		<button type = "submit" class = "btn btn-success" >View Achievements</button>
	</form>
	<form  action = "${username }/viewParticipation">
		<button type = "submit" class = "btn btn-success" >View Participations</button>
	</form>
	<form  action = "${username }/viewTransactions">
